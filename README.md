...
- Graphical user interface for connecting to TypeDB without the use of command line tools, libraries,
  or Driver API.
- Network encryption and authentication support (for TypeDB Enterprise and TypeDB Cloud).
