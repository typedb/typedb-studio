...
internal class JSONOutput constructor(
    ...
    companion object {
        ...
        @Composable
        fun create(transactionState: TransactionState): JSONOutput {
            return JSONOutput(TextEditor.createState(END_OF_OUTPUT_SPACE), transactionState, Theme.studio)
        }
    }
    ...
    override val name: String = Label.JSON
    override val icon: Icon = Icon.JSON
