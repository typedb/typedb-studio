...
def vaticle_typedb_driver():
    git_repository(
        ...
        commit = "7b18b5964323b43ec8764349a01e5814cd68e1a1",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
