...
def vaticle_typedb_driver():
    git_repository(
        ...
        commit = "f6747537ed90f039090e39ac9e8d67045d32b2fe",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
