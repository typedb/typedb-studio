...
def vaticle_typedb_driver():
    git_repository(
        ...
        commit = "baa12a581b7408c86bb475b818a95f627fd16599",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
