...
suspend fun simulationRunnerCoroutine(simulation: TypeDBForceSimulation, dataStream: QueryResponseStream,
    ...
    while (true) {
        withFrameNanos {
            ...
            try {
                if (System.nanoTime() - dataStream.lastFetchedNanos > 5e7 /* 50ms */) {
                    fetchNewData(simulation, dataStream)
                }
...
fun fetchNewData(simulation: TypeDBForceSimulation, dataStream: QueryResponseStream) {
