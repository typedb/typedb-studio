...
if (dependencies) {
  ...
  try {
    // Find the reason for why the dependency is installed. If it is installed because of a devDependency
    // then that is okay. Warn when it is installed because of a dependency
