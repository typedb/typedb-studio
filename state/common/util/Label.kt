...
object Label {
    ...
    const val DARK_GRAPH_NAME = "Dark"
    const val LIGHT_GRAPH_NAME = "Light"
    ...
    const val CHANGE_OVERRIDDEN_ROLE_TYPE = "Change Overridden Role Type"
    const val CHANGE_OVERRIDDEN_TYPE = "Change Overridden Type"
    ...
    const val SET_GRAPH_THEME = "Set Graph Theme"
