...
object Label {
    ...
    const val REMOVE_OWNS_ATTRIBUTE_TYPE = "Remove Owns Attribute Type"
    const val REMOVE_PLAYS_ROLE_TYPE = "Remove Plays Role Type"
    ...
    const val UNDEFINE_RELATES_ROLE_TYPE = "Undefine Relates Role Type"
