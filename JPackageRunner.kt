...
fun main(args: Array<String>) {
    val (srcFilename, applicationName, mainJar, mainClass, outFilename) = args
...
fun runShell(script: List<String>, baseDir: Path = Paths.get("."), expectExitValueNormal: Boolean = true): ProcessResult {
